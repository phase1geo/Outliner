...
public class FormattedText {
  ...
  //-------------------------------------------------------------
  // Copies the selected portion of the given FormattedText instance
  // to this instance
  ...
  // main components.  This is useful for changing the theme for a
  // temporary context.
  ...
  //-------------------------------------------------------------
  // Sets the start value of match to the next/previous match if
  // a search match exists in the text.
